...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
        ...
        <form action="/send_monthly_invoice/{{$student->id}}" method="POST">
            @csrf
            <div class="row">
            ...
            <div class="row mt-4">
                <div class="col-lg-6">
                    ...
                    <input type="date" name="grace_period" >
                </div>
            ...
            <button type="submit" class="btn btn-sm btn-success mt-3">Send Monthly Fee Invoice</button>
            </div>
